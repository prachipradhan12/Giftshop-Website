...
<center>
  <h2><a href="#sw" style="font-style:italic;">Sweets</a>&nbsp;&nbsp;<a href="#fl" style="font-style:italic">Flowers </a>&nbsp;&nbsp;<a href="#to" style="font-style:italic">Toys</a></h2>
</center>
<div align="center">
<h1 class="head"><a  name="sw">Sweets</a></h1>
...
<div align="center">
<h1  class="head"><a name="fl">Flowers</a></h1>
	<table border="0" cellpadding="2px" width="600px">
		<?php
			$result=mysql_query("select * from gifts where category='f'") or die("select * from gifts where category='f'"."<br/><br/>".mysql_error());
			while($row=mysql_fetch_array($result)){
		?>
		<tr><td colspan="2"><hr size="1" /></td></tr>
    	<tr >
...
<div align="center">
<h1  class="head"><a name="to">Toys</a></h1>
	<table border="0" cellpadding="2px" width="600px">
		<?php
